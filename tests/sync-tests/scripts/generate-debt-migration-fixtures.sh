...
sync_tests_directory=$(dirname "$script_directory")
repository_directory=$(cd "$sync_tests_directory/../.." && pwd)
migrations_directory="$repository_directory/packages/app/drizzle"
journal_path="$migrations_directory/meta/_journal.json"
fixture_directory="$sync_tests_directory/fixtures/debt-migration"
