...
export const ARTICLE_METADATA: ArticleRegistryEntryInterface = {
    ...
    description: msg`A deep-dive into how Budgie keeps your financial data on your device: local storage, encryption at rest, and device-to-device sync with no cloud copy.`,
    ...
    seoDescription: msg`Discover exactly how Budgie keeps your financial data off the cloud: local-only storage, encryption at rest, device sync, and open-source transparency.`,
