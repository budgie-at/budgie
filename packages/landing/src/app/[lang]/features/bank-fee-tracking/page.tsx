...
import { BankFeeTrackingHowItWorksSection } from './bank-fee-tracking-how-it-works-section/bank-fee-tracking-how-it-works-section';
...
export default async function BankFeeTrackingFeaturePage(props: PageLangParam) {
    ...
    return (
        <main className="flex-1">
            ...
            <BankFeeTrackingHowItWorksSection />
