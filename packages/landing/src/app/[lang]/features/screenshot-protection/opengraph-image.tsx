...
const OgImage = async ({ params }: { params: Promise<{ lang: string }> }) => {
    ...
    return createFeatureOgImage(
        t(i18n)`Screenshot Protection`,
        t(i18n)`Accidental shares stay private.`,
        [t(i18n)`privacy`, t(i18n)`screenshots`, t(i18n)`security`],
        resolveOgPlate('screenshot-protection', lang)
    );
};
