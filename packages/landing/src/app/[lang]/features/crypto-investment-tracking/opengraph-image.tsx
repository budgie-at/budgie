...
const OgImage = async ({ params }: { params: Promise<{ lang: string }> }) => {
    ...
    return createFeatureOgImage(
        t(i18n)`Crypto Portfolio`,
        t(i18n)`Two hundred crypto assets in one dashboard.`,
        [t(i18n)`crypto`, t(i18n)`bitcoin`, t(i18n)`net worth`],
        resolveOgPlate('crypto-investment-tracking', lang)
    );
};
