...
const OgImage = async ({ params }: { params: Promise<{ lang: string }> }) => {
    ...
    return createFeatureOgImage(
        t(i18n)`Split Transactions`,
        t(i18n)`One receipt, multiple categories.`,
        [t(i18n)`split`, t(i18n)`categories`, t(i18n)`transactions`],
        resolveOgPlate('split-transactions', lang)
    );
};
