...
export const alt = 'Bank Sync & Statement Import — Budgie';
...
const OgImage = async ({ params }: { params: Promise<{ lang: string }> }) => {
    ...
    return createFeatureOgImage(
        i18n._(BANK_SYNC_PILLAR_HUB_METADATA.metaTitle),
        fitText(i18n._(BANK_SYNC_PILLAR_HUB_METADATA.metaDescription), MAX_OG_TAGLINE_CHARS),
        BANK_SYNC_PILLAR_HUB_METADATA.seoKeywords.slice(0, 3).map(keyword => i18n._(keyword)),
