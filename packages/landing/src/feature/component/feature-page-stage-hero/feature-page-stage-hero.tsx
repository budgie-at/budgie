...
export const FeaturePageStageHero = ({ locale, heading, tagline, breadcrumbs, children }: Props) => (
    <section className="w-full pt-12 pb-16 md:pt-20 md:pb-24 bg-gradient-to-b from-emerald-50/40 to-background dark:from-emerald-950/20">
        <div className="container px-4 md:px-6 max-w-6xl grid gap-12 lg:grid-cols-[minmax(0,1fr)_21rem] lg:items-center">
            <div>
                {breadcrumbs}
