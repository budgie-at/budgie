...
export const metadata = {
    ...jsonMetadata,
    "title": "Warum Offline-First der einzige Weg für Ihre finanzielle Privatsphäre ist",
    "description": "Erfahren Sie, warum Offline-First-Anwendungen entscheidend für den Schutz Ihrer Finanzdaten sind und wie Budgie Ihre Privatsphäre bewahrt.",
    "tags": ["Privatsphäre", "Sicherheit", "Offline-First", "finanzielle-Privatsphäre", "Datenschutz"],
    "seo": {
        "keywords": [
            "offline-first Finanz-App",
            "finanzielle Privatsphäre",
            "sicherer Ausgaben-Tracker",
            "private Budget-App",
            "Offline-Ausgabenverfolgung",
            "Datenschutz",
            "finanzielle Sicherheit",
            "Local-First App",
            "privatsphäreorientiertes Budgeting",
            "sicheres Finanzmanagement"
        ],
        "metaDescription": "Erfahren Sie, warum Offline-First-Architektur entscheidend für den Schutz Ihrer finanziellen Privatsphäre ist. Entdecken Sie, wie Budgie Ihre Daten sicher auf Ihrem Gerät hält – fern von Cloud-Risiken."
    }
}
