        ...
        <div className="container px-4 md:px-6 relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
                ...
                <HowItWorksSectionStep
                    description={<Trans>Get Budgie from the app store. No registration required—your privacy starts immediately.</Trans>}
                    index={0}
                    step="01"
                    title={<Trans>Download &amp; Install</Trans>}
                />

                <HowItWorksSectionStep
                    description={
                        <Trans>Securely link your bank accounts, crypto wallets, and investment accounts for automatic tracking.</Trans>
                    }
                    index={1}
                    step="02"
                    title={<Trans>Connect Your Accounts</Trans>}
                />

                <HowItWorksSectionStep
                    description={
                        <Trans>Monitor expenses, set goals, track debts, and gain insights—all while keeping your data private.</Trans>
                    }
                    index={2}
                    step="03"
                    title={<Trans>Track Everything</Trans>}
                />
            </div>
        </div>
    </section>
