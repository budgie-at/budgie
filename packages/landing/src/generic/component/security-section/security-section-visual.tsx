        ...
        <div className="relative bg-linear-to-br from-primary/10 to-secondary/10 rounded-3xl p-8 md:p-12">
            ...
            <div className="relative space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <SecuritySectionBadge icon={<Lock className="size-5 text-green-500" />} label={<Trans>AES-256 Encrypted</Trans>} />
                    <SecuritySectionBadge icon={<Eye className="size-5 text-green-500" />} label={<Trans>Zero Tracking</Trans>} />
                    <SecuritySectionBadge
                        icon={<Smartphone className="size-5 text-green-500" />}
                        label={<Trans>Device-Only Storage</Trans>}
                    />
                    <SecuritySectionBadge icon={<Shield className="size-5 text-green-500" />} label={<Trans>No Data Mining</Trans>} />
                </div>
            </div>
        </div>
    </Motion>
