...
export default function LandingPage() {
  ...
  const savings = billingCycle === "yearly" ? monthlyPrice * 12 - yearlyPrice * 12 : 0
          ...
          <div className="container py-6 px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Budgie is the offline-first expense tracker that keeps your financial data completely private. Track
                cash, crypto, stocks, and bank accounts across multiple currencies—all stored securely on your device.
              </p>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <p className="text-sm font-medium text-muted-foreground">
                Syncs with 1000+ banks and financial institutions
              </p>
          ...
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Budgie combines powerful expense tracking with complete privacy. Track every dollar, euro, or bitcoin
                while keeping your financial data exactly where it belongs—on your device.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Get Budgie from the app store. No registration required—your privacy starts immediately.",
                },
                {
                  step: "02",
        ...
        <section className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
                Smart Financial Insights, Privately Powered
              </h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Get instant answers about your spending with Budgie's on-device AI. No data leaves your phone—smart
                analysis happens locally for complete privacy.
              </p>
            </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Ask questions like "Why is there so little money?" and get detailed breakdowns of your spending
                        patterns, unusual transactions, and budget insights.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Your financial data never leaves your device. The AI runs locally, ensuring your spending habits
                        and financial questions remain completely private.
                      </p>
                    </div>
                  </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  quote:
                    "Finally, an expense tracker that doesn't spy on me! Budgie works perfectly offline and my bank sync is seamless. Love the multi-currency support.",
                  author: "Sarah Chen",
                  role: "Digital Nomad",
                  rating: 5,
                },
                {
                  quote:
                    "The crypto tracking is incredible. I can see all my DeFi positions alongside my traditional accounts. The privacy-first approach sold me immediately.",
                ...
                {
                  quote:
                    "As a freelancer with multiple currencies, Budgie is a lifesaver. The debt tracking helped me pay off my student loans 6 months early!",
                ...
                {
                  quote:
                    "Open source AND private? This is exactly what I was looking for. The goal tracking feature keeps me motivated to save for my house down payment.",
                  author: "David Kim",
                ...
                {
                  quote:
                    "I've tried every expense app out there. Budgie is the only one that works completely offline while still syncing my bank accounts when I'm online.",
                  author: "Lisa Patel",
                  role: "Travel Blogger",
                  rating: 5,
                },
                {
                  quote:
                    "The stock portfolio tracking alongside my daily expenses gives me a complete financial picture. Plus, knowing my data never leaves my phone is priceless.",
                  author: "James Wilson",
                  ...
                  <div className="text-center space-y-6">
                    <div className="space-y-4">
                      ...
                      <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
                        Be among the first to experience Budgie Pro with exclusive early access pricing. Limited spots
                        available for privacy-conscious early adopters.
                      </p>
                    </div>
                    ...
                    <div className="mt-8 p-4 bg-muted/50 rounded-lg border border-border/40">
                      <p className="text-sm text-muted-foreground">
                        <strong className="text-foreground">Limited Offer:</strong> Only 500 whitelist spots available.
                        Get 25% off your first year of Budgie Pro when you join the whitelist.
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                {[
                  {
                    ...
                    answer:
                      "Budgie Pro costs $20/month or $16/month when billed annually (20% savings). Whitelist members get an exclusive 25% discount for their first year. This premium pricing ensures we can maintain the highest privacy and security standards without relying on data monetization.",
                  },
                  {
                    question: "Why isn't Budgie free like other expense trackers?",
                    answer:
                      "Free expense apps make money by selling your financial data or showing ads. Budgie's premium model means we work for you, not advertisers. Your subscription funds ongoing development, security updates, and ensures your data remains completely private—never sold or monetized.",
                  },
                  {
                    question: "How is my financial data kept private?",
                    answer:
                      "Your data never leaves your device unless you explicitly sync with your own cloud storage. We don't have servers storing your financial information, and we can't see your transactions. Everything is encrypted locally on your device.",
                  },
                  {
                    question: "Does bank sync work offline?",
                    answer:
                      "Bank sync requires an internet connection to fetch new transactions, but once synced, you can view and categorize everything offline. The app works completely offline for manual expense entry and viewing your data.",
                  },
                  {
                    question: "What cryptocurrencies and assets can I track?",
                    answer:
                      "Budgie supports tracking for major cryptocurrencies, stocks, ETFs, and traditional bank accounts. You can manually add any asset or connect supported exchanges and brokerages for automatic tracking.",
                  },
                  {
                    question: "Can I use Budgie across multiple devices?",
                    answer:
                      "Yes! You can sync your data across devices using your own cloud storage (iCloud, Google Drive, Dropbox). Your data remains encrypted and private—we never see it during the sync process.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer:
                      "We offer a 14-day free trial so you can experience Budgie's privacy-first approach risk-free. If you're not completely satisfied within 30 days, we provide a full refund—no questions asked.",
                  },
                ].map((faq, i) => (
                  <motion.div
                    key={i}
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                The privacy-first expense tracker that keeps your financial data exactly where it belongs—on your
                device.
              </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} Budgie. All rights reserved.
            </p>
            <div className="flex gap-4">
