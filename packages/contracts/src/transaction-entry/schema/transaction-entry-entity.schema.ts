...
import { bigint, enum as zodEnum } from 'zod';
...
export const TransactionEntryEntitySchema = createSelectSchema(TransactionEntryEntityTable, {
    ...
    categoryId: schema => schema.positive().describe('Id of the category the entry belongs to'),
    ...
    amount: bigint().positive().describe('Amount of the entry')
});
