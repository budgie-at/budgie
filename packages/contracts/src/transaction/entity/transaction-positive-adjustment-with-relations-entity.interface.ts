...
export interface TransactionPositiveAdjustmentWithRelationsEntityInterface
    extends Omit<TransactionWithRelationsEntityInterface, TransactionAssociationEnum.TO_ACCOUNT | 'type'> {
