...
import { RuleWithRelationsEntityInterface } from '../../rule/entity/rule-with-relations-entity.interface';
...
export interface TransactionWithRelationsEntityInterface extends TransactionEntityInterface {
    [TransactionAssociationEnum.APPLIED_RULE]?: RuleWithRelationsEntityInterface | null;
