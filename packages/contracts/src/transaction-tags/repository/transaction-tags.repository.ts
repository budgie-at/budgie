...
export class TransactionTagsRepository {
    ...
    async bulkCreate(inputs: TransactionTagsCreateEntityInterface[], tx?: Transaction): Promise<TransactionTagsEntityInterface[]> {
    ...
    async deleteByTransactionId(id: number, tx?: Transaction): Promise<void> {
