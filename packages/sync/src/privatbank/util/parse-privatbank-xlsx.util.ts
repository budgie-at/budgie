...
const createParseError = (message: string, originalError?: unknown): SyncError =>
    new SyncError(SyncErrorCodeEnum.INVALID_RESPONSE, message, SyncProviderEnum.PRIVATBANK, originalError);
