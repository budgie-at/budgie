...
export const IconSelectorCardMedium = ({ className, icon, onPress, variant = 'default' }: Props) => (
    <HapticPressable onPress={onPress} className={cn(cardVariants({ variant }), className)}>
        <CircleIcon size="1_25xl" icon={ICONS[icon]} variant={variant} className="rounded-5xl" />
