...
export const SettingsPageSelector = {
    ...
    RunwayWidgetCard: 'SettingsPage.RunwayWidgetCard',
    RunwayWidgetSwitch: 'SettingsPage.RunwayWidgetSwitch',
    RunwayWidgetSwitchStateOn: 'SettingsPage.RunwayWidgetSwitch.State.On',
    RunwayWidgetSwitchStateOff: 'SettingsPage.RunwayWidgetSwitch.State.Off',
