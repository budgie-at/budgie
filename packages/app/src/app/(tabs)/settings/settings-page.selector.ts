...
export const SettingsPageSelector = {
    ...
    AiEnabledCard: 'SettingsPage.AiEnabledCard',
    AiEnabledSwitch: 'SettingsPage.AiEnabledSwitch',
    AiEnabledSwitchStateOn: 'SettingsPage.AiEnabledSwitch.State.On',
    AiEnabledSwitchStateOff: 'SettingsPage.AiEnabledSwitch.State.Off',
    RunwayPillCard: 'SettingsPage.RunwayPillCard',
    RunwayPillSwitch: 'SettingsPage.RunwayPillSwitch',
    RunwayPillSwitchStateOn: 'SettingsPage.RunwayPillSwitch.State.On',
    RunwayPillSwitchStateOff: 'SettingsPage.RunwayPillSwitch.State.Off',
    RunwayCryptoCard: 'SettingsPage.RunwayCryptoCard',
    RunwayCryptoSwitch: 'SettingsPage.RunwayCryptoSwitch',
    RunwayCryptoSwitchStateOn: 'SettingsPage.RunwayCryptoSwitch.State.On',
    RunwayCryptoSwitchStateOff: 'SettingsPage.RunwayCryptoSwitch.State.Off',
