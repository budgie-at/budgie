...
// eslint-disable-next-line max-statements -- Animated strip component with multiple hooks and animation values
export const RuleSuggestionStrip = (props: Props) => {
    ...
    const conditions = [{ field: RuleConditionFieldEnum.TITLE, operator: RuleConditionOperatorEnum.CONTAINS, value: suggestRuleData.title, secondaryValue: null }];

    if (isNotEmptyString(suggestRuleData.mccCode)) {
        conditions.push({ field: RuleConditionFieldEnum.MCC_CODE, operator: RuleConditionOperatorEnum.CONTAINS, value: suggestRuleData.mccCode, secondaryValue: null });
    }
