...
export const RuleApplyStatusBlock = ({ status }: Props) => {
    ...
    if (status.isLoading) {
        return (
            <View className="bg-secondary-background border-secondary-corner items-center rounded-2xl border py-xl">
                <ActivityIndicator />
            </View>
        );
    }
    ...
    if (status.matched === 0) {
        return (
            <View className="bg-secondary-background border-secondary-corner rounded-2xl border px-xl py-md">
