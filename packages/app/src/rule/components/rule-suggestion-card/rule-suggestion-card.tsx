import { RuleActionTypeEnum, RuleConditionMatchTypeEnum, RuleCreateInputInterface, UserIconNameEnum } from '@budgie/contracts';
...
export const RuleSuggestionCard = (props: Props) => {
    ...
    const descriptionText = t`Quick rule`;
