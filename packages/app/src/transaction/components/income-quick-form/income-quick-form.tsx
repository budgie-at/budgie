...
export const IncomeQuickForm = ({ variant, onSubmit }: Props) => {
    ...
    const handleConfirm = () => {
        ...
        const accountId = getValues('toAccountId') ?? 0;
        ...
        const entries = buildIncomeEntry({ accountId, categoryId, amount });
    ...
    return (
        <View className="flex-1">
            ...
            <View className="mb-xl">
                <TransactionAccountRow variant={variant} fieldName="toAccountId" />
            </View>
