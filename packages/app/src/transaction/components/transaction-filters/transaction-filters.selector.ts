...
export const TransactionFiltersSelector = {
    ...
    AmountChip: 'TransactionFilters.AmountChip',
    AmountChipActive: 'TransactionFilters.AmountChipActive',
    AmountFromInput: 'TransactionFilters.AmountFromInput',
    AmountToInput: 'TransactionFilters.AmountToInput',
    AmountApplyButton: 'TransactionFilters.AmountApplyButton',
