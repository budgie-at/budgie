...
export const EmbeddingStatus = () => {
    const { t } = useLingui();
    const { embeddedCount, totalUniqueContexts, isLlmReady } = useEmbeddingStatus();

    const statusDescription = isLlmReady ? t`${embeddedCount} of ${totalUniqueContexts} contexts embedded` : t`AI model not loaded`;
