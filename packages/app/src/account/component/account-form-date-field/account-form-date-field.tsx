...
export const AccountFormDateField = ({ control, variant }: Props) => {
    ...
    const renderDateInput = ({ field: { value, onChange } }: UseControllerReturn<DebtAccountCreateInputInterface, 'dateToReturn'>) => (
    ...
    return <Controller render={renderDateInput} name='dateToReturn' control={control} />;
};
