...
--> statement-breakpoint
INSERT INTO `__new_transaction_entries`("id", "createdAt", "updatedAt", "deletedAt", "type", "account_id", "category_id", "instrument_id", "transaction_id", "amount") SELECT "id", "createdAt", "updatedAt", "deletedAt", "type", "account_id", "category_id", "instrument_id", "transaction_id", "amount" FROM `transaction_entries`;--> statement-breakpoint
